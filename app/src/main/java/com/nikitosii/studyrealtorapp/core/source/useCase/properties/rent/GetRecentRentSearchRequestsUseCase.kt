package com.nikitosii.studyrealtorapp.core.source.useCase.properties.rent
...
class GetRecentRentSearchRequestsUseCase @Inject constructor(
    private val repo: SearchRequestRepo
) : FlowUseCase<List<SearchRequest>>() {

    override fun execute(): Flow<List<SearchRequest>> = repo.getRecentSearchRequests(RequestType.RENT)
}